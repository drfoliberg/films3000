package org.drfoliberg.films3000.data.scrappers.local.mediainfo;

import java.io.File;
import java.util.ArrayList;

import org.drfoliberg.films3000.data.constants.Constantes;
import org.drfoliberg.films3000.data.scrappers.local.MediaScrapper;
import org.drfoliberg.films3000.data.scrappers.local.mediainfo.MediaInfo.StreamKind;
import org.drfoliberg.films3000.models.file.stream.Stream;
import org.drfoliberg.films3000.models.file.stream.AudioStream;
import org.drfoliberg.films3000.models.file.stream.TextStream;
import org.drfoliberg.films3000.models.file.stream.VideoStream;
...
public class MediaInfoAnalyse implements MediaScrapper {
	...
	public String getFormat() {
		...
		if (format.equals("")) {
			return Constantes.NOT_AVAILABLE;
		}
		return format;
	}
	...
	private TextStream getStreamTexte(int i){
		String langue = "";
		langue = info.get(StreamKind.Text, i, "Language/String");
		if (langue.equals("")) {
			langue = Constantes.NOT_AVAILABLE;
		}
		return new TextStream(langue, i);
	}

	private VideoStream getStreamVideo(int i) {
		String codec = "";
		int debit = 0;
		String qualite = "";
		int hauteur = 0;
		...
		return new VideoStream(codec, debit, qualite, hauteur, largeur, ips, dureeMs, i);
	}

	private AudioStream getStreamAudio(int i) {
		...
		return new AudioStream(codec, debit, canaux, langue, commentaire,
				dureeMs, i);
	}
